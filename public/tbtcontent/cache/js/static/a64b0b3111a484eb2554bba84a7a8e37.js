/* Wednesday 3rd of June 2020 05:56:21 PM*/
...
(function(dojo){ dojo.addOnLoad(function(){
            ...
            dojo.query('.noscript').removeClass('noscript');
            new AccordionMenu({
                node: dojo.query('#nextend-accordion-menu-nextendaccordionmenuwidget-25 dl.level1')[0],
                instance: 'nextend-accordion-menu-nextendaccordionmenuwidget-25',
                url: '',
                moduleid: 0,
                classPattern: /nextend-nav-[0-9]+/,
                mode: 'onclick', 
